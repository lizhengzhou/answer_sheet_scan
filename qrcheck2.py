...
def find(image, contours, hierachy, root=0):
    ...
    ox_sheet = four_point_transform(image,  box.reshape(4, 2))
    cv2.imshow("ox", ox_sheet)

    cv2.imwrite("qrtest20200530.jpg",ox_sheet);
    reader = zxing.BarCodeReader()
    barcode = reader.decode("qrtest20200530.jpg")
